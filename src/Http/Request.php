...
//	public static $secure;				// True | False -> 'HTTPS' | 'HTTP'
	...
	public static $uri;					// Request URI - path from base to requested page (root path ==> '/')
...
//	public static $script;				// Script name (with .php ext): <base>/<script-path>/<script>
	...
	*/
	...
	//	static::$secure = static::$scheme === 'https';
		...
		static::$uri = implode('/', static::$segments);
		...
		return [static::$uri, static::$method, static::$scheme];
	}
